...
<div class="container-fluid">
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('dampak-covid.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control" name="gambar" placeholder="Gambar Ilustrasi..." value="{{ $item->gambar }}">
                </div>

                <div class="form-group">
                    <label class="font-weight-bold" for="keterangan">Keterangan</label>
                    <textarea name="keterangan"   placeholder="Keterangan Terkait...">{{ $item->keterangan }}</textarea>
                </div>
