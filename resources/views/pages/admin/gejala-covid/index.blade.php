...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Gejala Covid</h1>
        <a href="{{ route('gejala-covid.create') }}" class="btn btn-sm btn-primary shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Tambah Gejala Covid
        </a>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                           ...
                           <td class="justify-content-center">
                            <a href="{{ route('gejala-covid.edit', $item->id) }} "class=" btn btn-warning m-1">
...
<script type="text/javascript">
    ...
    {
        var id = id;
        var url = '{{ route("gejala-covid.destroy", ":id") }}';
